  ...
  return (
    <div className={'banner relative w-full mb-5 lg:mb-[30px] flex flex-col-reverse items-center lg:block'}>
      <div className={'h-[360px] lg:h-[416px] z-[1] flex relative'}>
        ...
        >
          <h1 className={'font-semibold tracking-normal leading-[40px] text-[28px] lg:text-[32px]'}>{t('title')}</h1>
          <p className={'text-[14px] lg:text-[16px] font-normal text-[#606060] m-0 mt-[16px]'}>{t('banner-desc')}</p>
