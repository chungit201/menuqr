            ...
            <div className={''}>
              <ul>
                ...
                <li className={'flex gap-[15px] mb-[20px] text-[18px] font-normal'}>
                  ...
                  <Link className={'hover:text-[#69b1ff] font-semibold transition'} href="tel:0354851198">
                    035.485.1198
                  </Link>
                </li>
                <li className={'flex gap-[15px] mb-[20px] text-[18px] font-normal'}>
                  <Image src={require('@/common/assets/images/faststore-email-icon.f26712ab.svg')} alt={''} />
                  <Link className={'hover:text-[#69b1ff]  italic transition'} href="mailto:support@menuqr.vn">
                    support@menuqr.vn
                  </Link>
                </li>
              </ul>
